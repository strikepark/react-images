(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('glam'), require('raf-schd'), require('react-view-pager'), require('html-react-parser'), require('react-focus-on'), require('react-full-screen'), require('a11y-focus-store'), require('react-transition-group'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['react', 'glam', 'raf-schd', 'react-view-pager', 'html-react-parser', 'react-focus-on', 'react-full-screen', 'a11y-focus-store', 'react-transition-group', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Images = factory(global.React, global.glam, global.rafScheduler, global.PageView, global.ParseHtml, global.FocusOn, global.Fullscreen, global.focusStore, global.Transition, global.ReactDOM));
}(this, (function (React, glam, rafScheduler, reactViewPager, ParseHtml, reactFocusOn, reactFullScreen, focusStore, reactTransitionGroup, reactDom) { 'use strict';
  ...
  */
  ...
  var Carousel = function (_Component) {
    ...
    function Carousel(props) {
      ...
      return _this;
    } // Keep the same type, but this will now reference the component directly
    // TODO
  ...
  var _initialiseProps$1 = function _initialiseProps() {
    ...
    this.focusViewFrame = function () {
      if (_this2.frame) {
        ...
        if (typeof _this2.frame.focus === 'function') {
          _this2.frame.focus();
        }
        // Alternative: if Frame has a ref to its DOM element
        else if (_this2.frame.current && typeof _this2.frame.current.focus === 'function') {
            _this2.frame.current.focus();
          }
          // If Frame component has a method to get DOM node
          else if (typeof _this2.frame.getDOMNode === 'function') {
              var domNode = _this2.frame.getDOMNode();
